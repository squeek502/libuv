    ...
    ::
        ...
        enum uv_udp_flags {
            ...
            */
            ...
            UV_UDP_MMSG_CHUNK = 8,
            /*
             * Indicates that the buffer provided has been fully utilized by recvmmsg and that
             * it should now be freed by the recv_cb callback. When this flag is set in
...
.. c:type:: void (*uv_udp_recv_cb)(uv_udp_t* handle, ssize_t nread, const uv_buf_t* buf, const struct sockaddr* addr, unsigned flags)
    ...
    * `flags`: One or more or'ed UV_UDP_* constants.
    ...
    This is a good chance for the callee to free the provided buffer.

    .. versionchanged:: 1.38.0 added the `UV_UDP_MMSG_FREE` flag.
